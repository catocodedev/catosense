...
function activate(context) {
    ...
    const consolesettings = vscode.languages.registerCompletionItemProvider('plaintext', {
    ...
    const debugsettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
    ...
    const randomsettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
    ...
    const scriptsettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `send`, `send.kit`
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
    ...
    const scriptpausesettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `send`, `send.kit`
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
    ...
    const getsettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `send`, `send.kit`
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
    ...
    const atsettings = vscode.languages.registerCompletionItemProvider('plaintext', {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `send`, `send.kit`
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
